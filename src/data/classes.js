...
export const CLASSES = [
  ...
  },
  {
    ...
    apply(player) {
      ...
      player.weapons.push(w);
      for (const id of [
        'weapon_magic_missile', 'weapon_ice_bolt', 'weapon_fire_bolt',
        'weapon_lightning_bolt', 'weapon_chain_lightning', 'weapon_void_bolt',
        'weapon_orb', 'weapon_arcane_burst', 'weapon_shadow_bolt',
        'weapon_spectral_arrow', 'weapon_boulder_toss', 'weapon_venom_dart',
